...
class LogDiagnostic():
    ...
    def weighted_mean_merge(self, *args):
        ...
        weighted_stats = dict( (map(lambda (key, value): (key,float(value) / divisor), six.iteritems(superstats))) ) # dividing each of the superstats by the common divisor, this gives us the final weighted_stats
